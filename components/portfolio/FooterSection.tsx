...
export default function FooterSection() {
  ...
  return (
    <footer className="border-t border-zinc-200 bg-white px-5 py-8 sm:px-8 sm:py-10 lg:px-10">
      <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-6 sm:flex-row sm:items-end">
        <div className="flex flex-col items-center gap-1 sm:items-start">
          <span className="font-editorial text-balance text-[clamp(1.05rem,2.5vw,1.2rem)] font-bold italic text-zinc-950">{messages.footer.name}</span>
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 sm:justify-end sm:gap-8">
          <a
            ...
            className="font-mono text-[clamp(0.64rem,1.8vw,0.72rem)] uppercase tracking-[0.12em] text-zinc-400 transition-colors hover:text-zinc-950 sm:tracking-[0.15em]"
          >
