  ...
  const contactLinks = [
    {
      icon: MailIcon,
      title: "Email",
      value: "jakkapet@example.com",
      href: "mailto:jakkapet@example.com",
    },
    {
      icon: GithubIcon,
      title: "GitHub",
      value: "github.com/jakkapet",
      href: "https://github.com/jakkapet2k",
    },
    {
      icon: LinkedinIcon,
      title: "LinkedIn",
      value: "linkedin.com/in/jakkapet",
      href: "https://linkedin.com/in/jakkapet",
    },
    // {
    //   icon: PhoneIcon,
    //   title: "Phone",
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-12">
        ...
        <div ref={contentRef} className="grid md:grid-cols-2 gap-6">
          ...
          <div className="relative bg-gray-900/60 border border-dashed border-orange-500/20 p-6">
            ...
            <h3 className="text-orange-500 font-semibold text-sm uppercase tracking-wider mb-6">Send a Message</h3>
            ...
            <form className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full bg-gray-800/50 border border-gray-700 text-white px-4 py-2 text-sm focus:outline-none focus:border-orange-500/50 transition-colors"
              ...
              <div>
                ...
                <textarea
                  rows={4}
                  className="w-full bg-gray-800/50 border border-gray-700 text-white px-4 py-2 text-sm focus:outline-none focus:border-orange-500/50 transition-colors resize-none"
                  placeholder="Your message..."
                />
              </div>
              <button
                type="submit"
                className="w-full bg-orange-500/20 border border-orange-500/50 text-orange-500 py-2 text-sm uppercase tracking-wider hover:bg-orange-500/30 transition-colors"
              >
                Send Message
              </button>
            </form>
